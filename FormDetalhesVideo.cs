...
namespace Futtage
{
    public partial class FormDetalhesVideo : Form
    {
        ...
        private void SetupDefaultValues(DateTime dataDeCriacao)
        {
            ...
            // Descrição padrão
            txtDescricao.Text = @"🎥 Vídeo editado com Futtage
...
#Futtage #VideoEdit #YouTube";

            // Foco no final do título para facilitar edição
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            // Validação do tamanho do título (limite do YouTube: 100 caracteres)
            ...
            // Validação da descrição (limite do YouTube: 5000 caracteres)
            ...
            // Determinar privacidade baseada na seleção
